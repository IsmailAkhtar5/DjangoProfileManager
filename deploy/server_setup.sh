...
PROJECT_GIT_URL='https://github.com/IsmailAkhtar5/DjangoProfileManager.git'
...
apt-get update
apt-get install -y python3-dev python3-venv sqlite3 python3-pip supervisor nginx git  pkg-config libmysqlclient-dev
